...
- References to scripts/templates/docs as needed]
...
# Default version for new skills (each skill has independent versioning)
...
def init_skill(skill_name, path):
    ...
    try:
        ...
        # Create docs/ directory with example doc
        docs_dir = skill_dir / 'docs'
        docs_dir.mkdir(exist_ok=True)
        example_reference = docs_dir / 'api_reference.md'
        example_reference.write_text(EXAMPLE_REFERENCE.format(skill_title=skill_title))
        print("✅ Created docs/api_reference.md")
    ...
    print("2. Customize or delete the example files in scripts/, docs/, and assets/")
